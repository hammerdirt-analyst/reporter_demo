...
def admin_prompt_cantons_lakes(state):
    aprompt = (
        ...
        "2. If the title includes 'Lakes' or 'Rivers' summarize the 'sample results by canton' table. Include the number of cantons, the canton with the greatest number of samples"
        " the canton with the highest pcs/m and the canton with the greates quantity.\3. If the title includes the words 'Cantons' or 'Cities' summarize the sample results by feature_name table"
        ...
        " with the highest quantity.\n4 If their is more than one row in the 'sample results by feature_type' table summarize the differences otherwise do not include this section.\n"
